...
grabar(){
  ...
  (errorHttp:HttpErrorResponse)=>{
    ...
    mensaje += errorHttp.error?.codigo ? ( '- ' + errorHttp.error.error?.codigo) : "";
    mensaje += errorHttp.error?.marca ? ( '- ' + errorHttp.error.error?.marca) : "";
    mensaje += errorHttp.error?.modelo ? ( '- ' + errorHttp.error.error?.modelo) : "";
    mensaje += errorHttp.error?.anio ? ( '- ' + errorHttp.error.error?.anio) : "";
    alert(mensaje);
    })  
  }
}
